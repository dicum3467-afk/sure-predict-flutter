...
class _FixturesScreenState extends State<FixturesScreen> {
  late Future<List<PredictionItem>> _predictionsFuture;
  final PredictionsService _service = PredictionsService();

  @override
  void initState() {
    super.initState();
    _predictionsFuture = _service.fetchPredictions(limit: 50);
  }
          ...
          ExpansionTile(
            ...
            children: [
              ...
              _detailRow(
                ...
                item.model.avgHomeGoalsLeague.toStringAsFixed(2),
              ),
              _detailRow(
                'League avg away goals',
                item.model.avgAwayGoalsLeague.toStringAsFixed(2),
              ),
